Pod::Spec.new do |spec|
  ...
  #
  spec.source = { :http => 'https://res-download.s3.cn-northwest-1.amazonaws.com.cn/antibot/ios-sdk/frameworks/SwSDK/SwSDK-1.2.1-20240320.zip',
                :sha1 => 'b7fee9410282749478dbd90d4ec3a512c7dba44b' }
