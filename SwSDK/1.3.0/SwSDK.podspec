Pod::Spec.new do |spec|
  ...
  #
  spec.source = { :http => 'https://res-download.s3.cn-northwest-1.amazonaws.com.cn/antibot/ios-sdk/frameworks/SwSDK/SwSDK-1.3.0-20250630.zip',
                :sha1 => 'fe33f93743fcb56b5aee986632956e91dfef0eb5' }
